...
export default function SidebarProfile() {
  ...
  return (
    <div className={`space-y-6 ${isFixed ? "fixed top-24 right-8" : ""}`}>
      {/* Profile Image */}
      <div className="relative w-48 h-48 rounded-lg overflow-hidden border-2 border-cyan-500/30 hover:border-cyan-500/50 transition-colors">
      ...
      <div className="flex items-center justify-center h-48">
        <p className="text-slate-400 font-mono text-xs tracking-widest [writing-mode:vertical-rl] [text-orientation:mixed] rotate-180">
          Crafted By Me With Care
        </p>
      </div>
    </div>
  )
